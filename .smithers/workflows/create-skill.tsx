...
const outputSchema = z.object({
  skillName: z
    .string()
    .describe("The kebab-case id of the skill that was created."),
  skillPath: z
    .string()
    .nullable()
    .describe("Path to the written SKILL.md, if known."),
  approved: z
    .boolean()
    .describe("Whether the design was approved (or no approval was required)."),
  summary: z
    .string()
    .describe("Human-facing summary of what was created and how to use it."),
  filesWritten: z
    .array(z.string())
    .default([])
    .describe("Paths of the files the scaffold wrote."),
      ...
      <Sequence>
        ...
        <Task id="clarify" output={outputs.clarify} agent={agents.planning}>
          <ClarifyPrompt
            request={
              ctx.input.prompt ??
              "Describe the agent skill you want to create, in plain English."
            }
            name={ctx.input.name}
          />
        </Task>
